        ...
        <View style={styles.container}>
                                ...
                                <View style={styles.reviewHeader}>
                                    ...
                                    <View style={styles.reviewerInfo}>
                                        ...
                                        <View style={styles.starsRow}>
                                            {[1, 2, 3, 4, 5].map((s) => (
                                                <Ionicons key={s} name="star" size={14} color={s <= review.rating ? Colors.warning : Colors.textTertiary} />
                                            ))}
                                        </View>
                                    </View>
            ...
            {user?.role === 'athlete' && (
                <View style={styles.bottomBar}>
                    ...
                    <TouchableOpacity onPress={handleBooking} disabled={isBooking} activeOpacity={0.8} style={{ flex: 1 }}>
                        <LinearGradient
                            colors={[Colors.primary, Colors.gradientEnd]}
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
    ...
    avatar: { width: 92, height: 92, borderRadius: 28, backgroundColor: Colors.background, justifyContent: 'center', alignItems: 'center' },
    ...
    trainerName: { fontSize: FontSize.xxl, fontWeight: FontWeight.bold, color: Colors.text },
    ...
    statCard: { flex: 1, minWidth: '45%', backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, alignItems: 'center', borderWidth: 1, borderColor: Colors.border },
    ...
    sportChipText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.primary },
    locationCard: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, padding: Spacing.lg, backgroundColor: Colors.card, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.border },
    locationText: { fontSize: FontSize.md, color: Colors.text },
    reviewCard: { backgroundColor: Colors.card, borderRadius: BorderRadius.md, padding: Spacing.lg, marginBottom: Spacing.sm, borderWidth: 1, borderColor: Colors.border },
    ...
    bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.xxl, paddingVertical: Spacing.lg, paddingBottom: 36, backgroundColor: Colors.card, borderTopWidth: 1, borderTopColor: Colors.border, gap: Spacing.lg },
    messageBtn: { width: 52, height: 52, borderRadius: 14, borderWidth: 1.5, borderColor: Colors.primary, justifyContent: 'center', alignItems: 'center' },
    priceContainer: {},
    ...
    bookButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 52, borderRadius: BorderRadius.md, gap: Spacing.sm, ...Shadows.glow },
    bookButtonText: { fontSize: FontSize.lg, fontWeight: FontWeight.bold, color: '#fff' },
});

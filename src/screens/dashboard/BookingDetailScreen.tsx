...
const STATUS_CONFIG: Record<string, { color: string; bg: string; icon: string; label: string }> = {
    pending: { color: Colors.warning, bg: Colors.warningLight, icon: 'hourglass', label: 'Pending' },
    confirmed: { color: Colors.info, bg: Colors.infoLight, icon: 'checkmark-circle', label: 'Confirmed' },
    ...
    no_show: { color: Colors.error, bg: Colors.errorLight, icon: 'alert-circle', label: 'No-Show' },
    disputed: { color: Colors.warning, bg: Colors.warningLight, icon: 'flag', label: 'Disputed' },
};
            ...
            <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.infoCard}>
                    <View style={styles.infoRow}>
                        ...
                        <Text style={[styles.infoValue, { color: Colors.success }]}>${Number(booking.price).toFixed(2)}</Text>
                    </View>
                    <View style={styles.infoRow}>
                        ...
                        {booking.status === 'confirmed' && (
                            <View style={styles.actionRow}>
                                ...
                                >
                                    ...
                                    <Text style={[styles.actionButtonText, { color: Colors.warning }]}>No-Show</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.actionButton, styles.actionDecline]}
                ...
                {!isTrainer && (booking.status === 'pending' || booking.status === 'confirmed') && (
                    <View style={styles.actionsSection}>
                        ...
                        >
                            <Ionicons name="close-circle" size={20} color={Colors.error} />
                            <Text style={[styles.actionButtonText, { color: Colors.error }]}>Cancel Booking</Text>
                        </TouchableOpacity>
                    </View>
                )}
...
const styles = StyleSheet.create({
    ...
    userCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.card, padding: Spacing.lg, borderRadius: BorderRadius.lg, borderWidth: 1, borderColor: Colors.border, marginBottom: Spacing.xxl },
    ...
    userAvatarText: { fontSize: FontSize.lg, fontWeight: FontWeight.bold, color: Colors.primary },
    userInfo: { flex: 1 },
    ...
    messageButton: { width: 44, height: 44, borderRadius: 14, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center' },
    ...
    infoCard: { backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.md, borderWidth: 1, borderColor: Colors.border, marginBottom: Spacing.md },
    ...
    notesInput: { backgroundColor: Colors.surface, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.border, padding: Spacing.md, color: Colors.text, fontSize: FontSize.md, minHeight: 100 },
    saveNotesButton: { alignSelf: 'flex-end', paddingHorizontal: Spacing.xl, paddingVertical: Spacing.sm, borderRadius: BorderRadius.md, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, marginTop: Spacing.sm },
    saveNotesButtonText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.primary },
    ...
    actionNoShow: { backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.warning },
    actionDecline: { backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.error },
    actionButtonText: { fontSize: FontSize.md, fontWeight: FontWeight.bold },
    actionButtonTextWhite: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: '#fff' },

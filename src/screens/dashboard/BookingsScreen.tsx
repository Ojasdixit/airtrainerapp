...
const STATUS_CONFIG: Record<string, { color: string; bg: string; icon: string; label: string }> = {
    ...
    confirmed: { color: Colors.info, bg: Colors.infoLight, icon: 'checkmark-circle-outline', label: 'Confirmed' },
    completed: { color: Colors.success, bg: Colors.successLight, icon: 'trophy-outline', label: 'Completed' },
    cancelled: { color: Colors.error, bg: Colors.errorLight, icon: 'close-circle-outline', label: 'Cancelled' },
    no_show: { color: Colors.error, bg: Colors.errorLight, icon: 'alert-circle-outline', label: 'No Show' },
    disputed: { color: Colors.warning, bg: Colors.warningLight, icon: 'warning-outline', label: 'Disputed' },
};
                    ...
                    <View style={styles.cardContent}>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <View style={styles.infoItem}>
                                ...
                                <Text style={[styles.infoText, { color: Colors.success }]}>${Number(item.total_paid).toFixed(0)}</Text>
                            </View>
                        </View>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    bookingCard: { backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, marginBottom: Spacing.md, borderWidth: 1, borderColor: Colors.border, ...Shadows.small },
    ...
    dateMonth: { fontSize: FontSize.xs, fontWeight: FontWeight.medium, color: Colors.primary, textTransform: 'uppercase' },
    cardContent: { flex: 1 },
    sportRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
    sportLabel: { fontSize: FontSize.lg, fontWeight: FontWeight.bold, color: Colors.text },
    ...
    actionBtnSecondaryText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.primary },
    actionBtnPrimary: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 38, borderRadius: BorderRadius.md, backgroundColor: Colors.primary, gap: 6 },
    actionBtnPrimaryText: { fontSize: FontSize.sm, fontWeight: FontWeight.bold, color: '#fff' },

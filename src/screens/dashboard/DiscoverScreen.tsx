            ...
            <View style={styles.cardHeader}>
                ...
                <View style={styles.cardInfo}>
                    ...
                    <View style={styles.metaRow}>
                        ...
                        <View style={styles.metaItem}>
                            <Ionicons name="star" size={12} color="#ffab00" />
...
const styles = StyleSheet.create({
    ...
    searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.border, marginHorizontal: Spacing.xxl, paddingHorizontal: Spacing.lg, height: 48, marginBottom: Spacing.md },
    ...
    sportFilterButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: Spacing.lg, height: 40, borderRadius: BorderRadius.pill, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, gap: 6 },
    sportFilterActive: { backgroundColor: Colors.primaryGlow, borderColor: Colors.primary },
    sportFilterEmoji: { fontSize: 16 },
    sportFilterText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.textSecondary },
    sportFilterTextActive: { color: Colors.primary },
    ...
    trainerCard: { backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, marginBottom: Spacing.md, borderWidth: 1, borderColor: Colors.border, ...Shadows.small },
    ...
    trainerName: { fontSize: FontSize.lg, fontWeight: FontWeight.bold, color: Colors.text },
    ...
    sportTagText: { fontSize: FontSize.xs, fontWeight: FontWeight.medium, color: Colors.primary },

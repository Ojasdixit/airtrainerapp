...
const NOTIF_ICONS: Record<string, { icon: string; color: string; bg: string }> = {
    NEW_REQUEST_NEARBY: { icon: 'location', color: Colors.info, bg: Colors.infoLight },
    BOOKING_CONFIRMED: { icon: 'checkmark-circle', color: Colors.success, bg: Colors.successLight },
    BOOKING_CANCELLED: { icon: 'close-circle', color: Colors.error, bg: Colors.errorLight },
    BOOKING_COMPLETED: { icon: 'trophy', color: Colors.success, bg: Colors.successLight },
    PAYMENT_RECEIVED: { icon: 'cash', color: Colors.success, bg: Colors.successLight },
    REVIEW_RECEIVED: { icon: 'star', color: Colors.warning, bg: Colors.warningLight },
    VERIFICATION_UPDATE: { icon: 'shield-checkmark', color: Colors.info, bg: Colors.infoLight },
...
const styles = StyleSheet.create({
    ...
    notifCard: { flexDirection: 'row', alignItems: 'flex-start', padding: Spacing.lg, backgroundColor: Colors.card, borderRadius: BorderRadius.lg, marginBottom: Spacing.sm, borderWidth: 1, borderColor: Colors.border },
    notifCardUnread: { backgroundColor: Colors.primaryGlow, borderColor: Colors.borderActive },
    ...
    notifTime: { fontSize: FontSize.xs, color: Colors.textTertiary, marginTop: 4 },
    unreadDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: Colors.primary, marginLeft: Spacing.sm, marginTop: 4 },

    ...
    return (
        ...
        >
            ...
            <View style={styles.statsGrid}>
                <LinearGradient colors={[Colors.primary, Colors.gradientEnd]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.statCardPrimary}>
            ...
            <View style={styles.section}>
                ...
                <View style={[styles.quickActionsGrid, { marginTop: Spacing.md }]}>
                    <TouchableOpacity style={styles.quickAction} onPress={() => navigation.navigate('TrainingOffers')}>
                        <View style={[styles.quickActionIcon, { backgroundColor: Colors.infoLight }]}>
                            <Ionicons name="paper-plane" size={22} color={Colors.info} />
                        </View>
                    ...
                    <TouchableOpacity style={styles.quickAction} onPress={() => navigation.navigate('EditProfile')}>
                        <View style={[styles.quickActionIcon, { backgroundColor: Colors.successLight }]}>
                            <Ionicons name="create" size={22} color={Colors.success} />
                        </View>
...
const styles = StyleSheet.create({
    ...
    statCard: { flex: 1, minWidth: '28%', backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, alignItems: 'center', borderWidth: 1, borderColor: Colors.border },
    ...
    requestCard: { backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, marginBottom: Spacing.md, borderWidth: 1, borderColor: Colors.border, ...Shadows.small },
    ...
    requestAvatarText: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.primary },
    requestInfo: { flex: 1 },
    requestName: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.text },
    requestSport: { fontSize: FontSize.sm, color: Colors.primary, marginTop: 1 },
    ...
    requestPriceValue: { fontSize: FontSize.xl, fontWeight: FontWeight.bold, color: Colors.success },
    ...
    declineBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 38, paddingHorizontal: Spacing.lg, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.error, gap: 4 },
    declineBtnText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.error },
    ...
    messageBtnText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.primary },
    acceptBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 38, borderRadius: BorderRadius.md, backgroundColor: Colors.primary, gap: 4 },
    acceptBtnText: { fontSize: FontSize.sm, fontWeight: FontWeight.bold, color: '#fff' },
    scheduleCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, marginBottom: Spacing.sm, borderWidth: 1, borderColor: Colors.border },
    scheduleTime: { alignItems: 'center', width: 60 },
    scheduleTimeText: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.primary },
    ...
    scheduleInfo: { flex: 1 },
    scheduleName: { fontSize: FontSize.md, fontWeight: FontWeight.semibold, color: Colors.text },
    ...
    quickAction: { flex: 1, backgroundColor: Colors.card, borderRadius: BorderRadius.lg, padding: Spacing.lg, alignItems: 'center', borderWidth: 1, borderColor: Colors.border, gap: Spacing.sm },
    quickActionIcon: { width: 48, height: 48, borderRadius: 14, justifyContent: 'center', alignItems: 'center' },
    quickActionLabel: { fontSize: FontSize.xs, fontWeight: FontWeight.medium, color: Colors.text },
});

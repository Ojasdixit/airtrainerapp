...
const styles = StyleSheet.create({
    ...
    convCard: { flexDirection: 'row', alignItems: 'center', padding: Spacing.lg, backgroundColor: Colors.card, borderRadius: BorderRadius.lg, marginBottom: Spacing.sm, borderWidth: 1, borderColor: Colors.border },
    ...
    avatarUnread: { borderWidth: 2, borderColor: Colors.primary },
    ...
    convSport: { fontSize: FontSize.xs, color: Colors.primary, marginTop: 2 },
    convMessage: { fontSize: FontSize.sm, color: Colors.textTertiary, marginTop: 4 },
    convMessageUnread: { color: Colors.text },
    unreadBadge: { width: 22, height: 22, borderRadius: 11, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center', marginLeft: Spacing.sm },
    unreadText: { fontSize: FontSize.xs, fontWeight: FontWeight.bold, color: '#fff' },
